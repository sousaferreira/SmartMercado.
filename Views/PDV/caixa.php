  ...
  <div class="tab-pane fade show active" id="todos-tab-pane" role="tabpanel" aria-labelledby="todos-tab" tabindex="0">
    <div class="row" id="row1">
          ...
          <div class="card shadow-sm border-0 rounded-3 h-100">
            <div class="card-body d-flex align-items-center gap-3">
              ...
              <div class="flex-grow-1">
                <h6 class="mb-1 fw-semibold text-dark text-truncate" title="<?= $produto['nome'] ?>">
                  <?= $produto['nome'] ?>
                </h6>
      ...
      <div class="pdv-footer d-flex justify-content-end mt-3">
        <a href="<?= BASE_URL ?>OperadorCaixa/CancelarVenda" class="btn btn-danger btn-cancelar me-2">Cancelar Venda</a><button class="btn btn-success btn-finalizar" data-bs-toggle="modal" data-bs-target="#ModalCaixa">Finalizar Venda</button>
        <a href="<?= BASE_URL?>OperadorCaixa/FecharCaixa/<?= $operador['caixa']?>/<?= $produto['id']?>" class="btn btn-danger btn-cancelar mx-2">Fechar caixa</a>
      </div>
    </div>
  </div>
