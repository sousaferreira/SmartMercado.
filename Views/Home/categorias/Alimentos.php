    ...
    <main class="container-fluid">
        ...
        <div id="myTab" role="tablist" class=" nav nav-tabs d-flex flex-nowrap overflow-auto mt-4 gap-3 shadow p-3 mb-5 bg-white rounded">
            <div class="nav-item" role="presentation">
                <a href='<?= BASE_URL ?>Site/Voltar' class="nav-link">
            ...
            <div class="nav-item" role="presentation">
                <a href='<?= BASE_URL ?>Site/Bebidas' class="nav-link"> <img src="<?= BASE_URL . 'Assets/img/produtos.png'; ?>" alt="Logo" width="50" class="d-inline-block align-text-top">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="todos-tab-pane" role="tabpanel" aria-labelledby="todos-tab" tabindex="0">
                <div class="row" id="row1">
                    <?php foreach ($alimentos as $produto): ?>
                        <?php $id = $produto['id'] ?>
